...
import com.rvngbrl.adulting.TaskTracker.ModifyTask;
import com.rvngbrl.adulting.TaskTracker.MyDatabaseHelper;
import com.rvngbrl.adulting.TaskTracker.NoScrollList;
import com.rvngbrl.adulting.TaskTracker.TaskAdapter;
...
public class ToDo extends AppCompatActivity {
    ...
    NoScrollList taskListToday, taskListTomorrow, taskListUpcoming;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CoordinatorLayout coordinatorLayout = findViewById(R.id.bg_layout);
    ...
    public void openModifyTask(View view) {
        startActivity(new Intent(this, ModifyTask.class));
    }
...
//                empty.setVisibility(View.GONE);
    ...
    public void loadListView(NoScrollList listView, final ArrayList<HashMap<String, String>> dataList) {
        TaskAdapter adapter = new TaskAdapter(this, dataList, mydb);
        listView.setAdapter(adapter);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view,
                                    int position, long id) {
                Intent i = new Intent(ToDo.this, ModifyTask.class);
