...
import com.rvngbrl.adulting.MoneyTracker.providers.ExpensesContract.ExpensesWithCategories;
import com.rvngbrl.adulting.R;

import static com.rvngbrl.adulting.MoneyTracker.ExpenseDbHelper.CATEGORIES_TABLE_NAME;
import static com.rvngbrl.adulting.MoneyTracker.ExpenseDbHelper.EXPENSES_TABLE_NAME;
...
public class ExpensesProvider extends ContentProvider {
    ...
    private static final String BASE_SELECT_JOIN_EXPENSES_CATEGORIES_QUERY =
            "SELECT " + EXPENSES_TABLE_NAME + "." + Expenses._ID + ", " +
                    ...
                    EXPENSES_TABLE_NAME + "." + Expenses.NOTE + ", " +
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        switch (sUriMatcher.match(uri)) {
            ...
            case EXPENSES_WITH_CATEGORIES:
                /*
                 * SELECT expenses._id, expenses.value, categories.name, expenses.date, expenses.note
                 * FROM expenses JOIN categories
                 * ON expenses.category_id = categories._id
                 */
...
//                "SELECT SUM(" + EXPENSES_TABLE_NAME + "." + Expenses.VALUE + ") as " +
//                        Expenses.VALUES_SUM + " FROM " + EXPENSES_TABLE_NAME +
//                        " WHERE " + EXPENSES_TABLE_NAME + "." + Expenses.DATE + " BETWEEN '" + lastSetBdgt+ "'  AND '" + dateBdgt + "' ";
